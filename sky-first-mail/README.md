...
## Bản UI Sky 2026
- Giao diện đăng nhập/thiết lập mới theo nhận diện Sky First, dùng logo thật trong `web/public/sky-first-logo.png`.
- Tông xanh trời nhạt/đậm, không dùng đăng nhập Google.
- Web Worker tự kiểm tra và bổ sung schema D1 còn thiếu khi API chạy, giúp hạn chế lỗi do quên chạy migration thủ công.
- Cloudflare Web Worker: Root directory `sky-first-mail/web`.
- Inbound Worker: Root directory `sky-first-mail/inbound-worker`.
